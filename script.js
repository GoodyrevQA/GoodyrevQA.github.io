...
function generateFood(){
	...
	//Если сгенерировали еду в змее, то генерируем заново
	if(isSnakeCollision){
		generateFood();
	}
}
